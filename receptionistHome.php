...
<body style="background: rgb(255, 255, 255);">
    ...
    <div style="height: 750px;">
        <h2 class="display-5 font-monospace text-center d-lg-flex justify-content-lg-center align-items-lg-center"
            style="height: 79px;">All Clients</h2>
                ...
                <div border: 1px solid #c3c3c3; display: flex; flex-wrap: wrap; align-content: center;>
                    <div border: 1px solid #c3c3c3; display: flex; flex-wrap: wrap; align-content: center;>
                        Toggle column: <a class="toggle-vis" data-column="0">Name</a> - <a class="toggle-vis"
                            data-column="1">Mobile</a> - <a class="toggle-vis" data-column="2">Email</a> - <a
                            class="toggle-vis" data-column="3">Pet Name</a> - <a class="toggle-vis" data-column="4">Pet
                            Type</a> - <a class="toggle-vis" data-column="5">Breed</a>
                    </div>
