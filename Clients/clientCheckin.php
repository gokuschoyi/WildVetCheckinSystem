<!-- Main page for clients to chekck in . Option to check in as a new client or existing client. -->
<?php session_start();
        ...
        <form action="process.php" method="POST">
            <div class="row">
                <div class="col d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center" style="height: 50px;">
                    <input class="form-control-sm d-xl-flex justify-content-xl-center align-items-xl-center" type="email" placeholder="Enter your email" style="border-radius: 30px;width: 228px;" name="enteredEmail" required="">
                </div>
            </div>
            <div class="row">
                <div class="col d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center" style="height: 50px;">
