    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            ?>
                ...
                <a href="docNotViewed.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                ...
                <div class="container-fluid ">
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2 align-items-center">
                                <div class="h5 mb-0 font-weight-bold text-gray-800  justify-content-center"><button
                                        type="submit" name="updateDocNotViewedclient" class=" btn btn-success">UPDATE</button></div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2 align-items-center">
                                <div class="h5 mb-0 font-weight-bold text-gray-800  justify-content-center"><button
                                        type="button" class=" btn btn-success" onclick="location.href='docNotViewed.php'"
                                        ;>GO BACK</button></div>
                            </div>
                        </div>
                    </div>
