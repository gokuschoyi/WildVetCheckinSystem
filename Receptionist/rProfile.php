<!-- Page tp edit and view the receptionist details -->
<?php
        ...
        <form method="POST" action="process.php">
                    ...
                    <div class="col-xl-6 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="font-size:1.2vw;">User ID</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="text" name="rid" value="<?php echo $stmt[0] ?>" class="form-control" placeholder=" Mobile Number"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="text" name="remail" value="<?php echo $stmt[3] ?>" class="form-control" placeholder=" Mobile Number"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-md-6 mb-4">
                        <div class="card border-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="font-size:1.2vw;">USER NAME</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="text" name="rname" value="<?php echo $stmt[1] ?>" class="form-control" placeholder=" Mobile Number"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="text" name="rpassword" value="<?php echo $stmt[2] ?>" class="form-control" placeholder=" Mobile Number"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2 align-items-center">
                                <div class="h5 mb-0 font-weight-bold text-gray-800  justify-content-center"><button type="submit" name="updatereception" class=" btn btn-success">UPDATE</button></div>
            ...
            <div class="container-fluid " style="padding-top:110px;">
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2 align-items-center">
                            <div class="h5 mb-0 font-weight-bold text-gray-800  justify-content-center"><button type="button" class=" btn btn-success" onclick="location.href='rDashboard.php'" ;>GO
                                    BACK</button></div>
                        </div>
                    </div>
                </div>
