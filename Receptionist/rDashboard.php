<!-- This is the home page for the receptionistafter successful login. The receptionist can access the all the major functionalities of the system from this page. -->
<?php
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        SEND SNIPPET (Total Remaining)</div>
                                    <?php
                                    $snippet = "No";
