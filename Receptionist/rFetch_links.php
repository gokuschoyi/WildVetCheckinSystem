<!-- This page fetches the necessary links from google or bing to show to the receptionist. Web scraping is implemetned to achieve this.  -->
<?php
...
<div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="rSendsnippet.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-long-arrow-alt-left fa-sm text-white-50"></i> GO BACK</a>
                </div>
                <!-- Content Row -->
                <div class="row">
                    ...
                    <div class="col-xl-12 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="font-size:1.2vw;">Doctor's Comments</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="text" name="petweight" value="<?php echo $stmt1[3] ?>" class="form-control" placeholder="None given by doctor."></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Table lsiting all the links fetched from google or bing -->
            <div class="container-fluid ">
                    ...
                    <form method="POST" action="rSendEmail.php">
                        <table id="linktable" class="display" style="width : 100%">
                            ...
                            <tbody>
                                ...
                                /* Function that returns links and titles from google */
                                ...
                                /* Function that returns links and title from bing */
                                ...
                                /* This functin returns a search qury to append to the google or bing search.
                                Search queries are created on the type of pet selected and some other criterias */
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <p><a href="<?php echo $a[0] ?>" target="PromoteFirefoxWindow" onclick="openRequestedPopup(this.href, this.target); return false;" title="This link will create a new window or will re-use an already opened one">Preview Link
                                                </a></p>
                                        </td>
                                        <td>
    ...
    ?>
    <!-- Storing the selected links in the array -->
    <script>
