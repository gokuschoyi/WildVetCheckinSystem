<!-- Page opened from the recovery link. The doctor enters the new password to reset it -->
<?php session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<body style="height: 1020px;background: url(&quot;assets/img/6677.jpg&quot;) center no-repeat;">
    <nav class="navbar navbar-light navbar-expand-md navigation-clean" style="height: 150px;background: #c292fb;">
        <div class="container"><a class="navbar-brand font-monospace" href="#" style="font-size: 35px;">The Wild
                Vet</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        </div>
    </nav>

    <h4 class="font-monospace text-center d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 133px;font-weight: bold;opacity: 0.85;font-size: 28.376px;">Password Recovery
    </h4>
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                <div class="col d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 50px; padding-right:10px;">
                                    <input class="form-control-sm d-lg-flex justify-content-lg-center align-items-lg-center" type="password" placeholder="New Password" style="border-radius: 13px;width: 200px;border-width: 1px;border-color: rgb(231,173,169);" name="rPassword" required="">
                                </div>
                            </div>
                            <div class="col-md-12 d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                <div class="col d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 50px; padding-right:10px;">
                                    <input class="form-control-sm d-lg-flex justify-content-lg-center align-items-lg-center" type="password" placeholder="Re-Entre New Password" style="border-radius: 13px;width: 200px;border-width: 1px;border-color: rgb(231,173,169);" name="rEnterPassword" required="">
                                </div>
                            </div>
                            <?php
                            $token = $_GET['token'];
                            ...
                            <div class="col-md-12 d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center" style="padding-top :30px;">
                                <button class="btn btn-primary btn-sm font-monospace d-lg-flex d-flex justify-content-center align-items-center" type="submit" name="receptionistCredentials" style="border-radius: 30px;background: rgb(157,126,207);height: 31px;width: 100px;">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
