<!-- This page gives the doctor or receptionist the option to recover either their username or pssword -->
<?php session_start(); ?>
<!DOCTYPE html>
<html lang="en">
...
<body style="height: 1020px;background: url(&quot;assets/img/6677.jpg&quot;) center no-repeat;">
    ...
    <!-- <?php
            ...
            ?> -->
    <h4 class="font-monospace text-center d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 133px;font-weight: bold;opacity: 0.85;font-size: 28px;">Username/Password Recovery
    </h4>

    <div class="container" style="height : 570px">
        <div class="row d-md-flex d-lg-flex d-xl-flex justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center" style="height : 260px">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="height: 70px;">
                            <h2 class="font-monospace d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center" style="color: rgb(93,72,96);height: 60px;">Receptionist</h2>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                <div class="col d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 50px; padding-right:10px;">
                                    <input class="form-control-sm d-lg-flex justify-content-lg-center align-items-lg-center" type="email" placeholder="Enter your Email" style="border-radius: 13px;width: 200px;border-width: 1px;border-color: rgb(231,173,169);" name="rEmail" required="">
                                </div>
                            </div>
                            <div class="col-md-12 d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                <div class="col d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 50px; padding-right:10px;">
                                    <button class="btn btn-primary btn-sm font-monospace d-lg-flex d-flex justify-content-center align-items-center" type="submit" name="usernameRecovery" style="border-radius: 30px;background: rgb(157,126,207);height: 31px;width: 100px;">Username</button>
                                    <button class="btn btn-primary btn-sm font-monospace d-lg-flex d-flex justify-content-center align-items-center" type="submit" name="passwordRecovery" style="border-radius: 30px;background: rgb(157,126,207);height: 31px;width: 100px;">Password</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="container">
                    ...
                    <form method="POST" action="process.php">
                        <div class="row">
                            <div class="col-md-12 d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                <div class="col d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 50px; padding-right:10px;">
                                    <input class="form-control-sm d-lg-flex justify-content-lg-center align-items-lg-center" type="email" placeholder="Enter your Email" style="border-radius: 13px;width: 200px;border-width: 1px;border-color: rgb(231,173,169);" name="dEmail" required="">
                                </div>
                            </div>
                            <div class="col-md-12 d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                <div class="col d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 50px; padding-right:10px;">
                                    <button class="btn btn-primary btn-sm font-monospace d-lg-flex d-flex justify-content-center align-items-center" type="submit" name="dusernameRecovery" style="border-radius: 30px;background: rgb(157,126,207);height: 31px;width: 100px;">Username</button>
                                    <button class="btn btn-primary btn-sm font-monospace d-lg-flex d-flex justify-content-center align-items-center" type="submit" name="doctorPasswordRecovery" style="border-radius: 30px;background: rgb(157,126,207);height: 31px;width: 100px;">Password</button>
                                </div>
                            </div>
                        </div>
                    </form>
