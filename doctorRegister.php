...
<body style="background: url(&quot;assets/img/6677.jpg&quot;) center no-repeat;">
    ...
    <h4 class="font-monospace text-center d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center" style="height: 133px;font-weight: bold;opacity: 0.85;font-size: 28.376px;">Doctor Register</h4>
    <div class="d-xl-flex justify-content-xl-center align-items-xl-start" style="height: 582px;">
        <form method="post" style="background: transparent;border-radius: 26px;max-width: 240px;width: 240px;">
            <h2 class="visually-hidden">Login Form</h2>
            <div class="d-xl-flex justify-content-xl-center align-items-xl-center illustration" style="height: 130px;"><img src="assets/img/password.png" style="width: 80px;"></div>
            <div class="mb-3"><input class="form-control" type="text" name="name" placeholder="First Name"></div>
            <div class="mb-3"><input class="form-control" type="text" name="username" placeholder="Username"></div>
            <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Email"></div>
            <div class="mb-3"><input class="form-control" type="email" name="password" placeholder="Password"></div>
            <div class="mb-3"><input class="form-control" type="password" name="cpassword" placeholder="Confirm Password"></div>
            <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" name  = "docRegister">Register</button></div>
            <p class="d-xl-flex justify-content-xl-center align-items-xl-center forgot">Already registered? </p><br/><a class="d-xl-flex justify-content-xl-center align-items-xl-center" href="doctorLogin.php">Login here</a>
        </form>
        <?php
