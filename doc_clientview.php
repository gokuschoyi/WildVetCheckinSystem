    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            ?>
                ...
                <a href="docHistory.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2 align-items-center">
                                <div class="h5 mb-0 font-weight-bold text-gray-800  justify-content-center"><buttontype="button" class=" btn btn-success" onclick="location.href='docHistory.php'";>GO BACK</button></div>
                            </div>
                        </div>
                    </div>
            </form>
